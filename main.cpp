...
int Random_army()
{
    ...
    for (int i = 0; i < t; i++)
    {
        ...
        if (t1 == 0)
        {
            ...
            if (level == 1 || level == 3)
            {
                rand_kolvo = Random(1, 3);
            }
            else if (level == 4 || level == 5)
            {
                rand_kolvo = Random(1, 5);
            }
            else if (level == 6 || level == 7)
            {
                rand_kolvo = Random(2, 7);
            }
            else
            {
                rand_kolvo = Random(3, 10);
            }
...
int ChooseUnit() //Магазин
{
    ...
    if (flag1 == false) //Если нет, то предлагаем повторить ввод
    {
        cout << "Error\n";
        Sleep(2000);
        goto st11;
...
int Battle()
{
    ...
    while (mpt) //цикл боя
    {
        ...
        if (niconico == true) //проверка на использование заклинания nico nico power
        {
            niconico = false;
            goto start;
        }
...
int bordel()
{
    ...
    else
    {
        ...
        if (a == 1) //Если выбрана "гей" принадлежность
        {
            ...
            if (a == 7) //Если рандомное число равно 7
